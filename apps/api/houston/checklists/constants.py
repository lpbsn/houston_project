...
CHECKLIST_BADGE_TODO = "todo"
CHECKLIST_BADGES = frozenset({CHECKLIST_BADGE_PROCESS, CHECKLIST_BADGE_TODO})
CHECKLIST_BADGE_DEFAULT = CHECKLIST_BADGE_TODO

EXECUTION_SOURCE_FLASH_TODO = "flash_todo"
