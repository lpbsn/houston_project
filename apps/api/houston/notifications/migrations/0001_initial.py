            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="notificatio_establi_6b0e62_idx",
                    ),
                    models.Index(
                        fields=["recipient_membership", "status"],
                        name="notificatio_recipie_01d9f4_idx",
                    ),
                    models.Index(
                        fields=["recipient_membership", "dedupe_key", "created_at"],
                        name="notificatio_recipie_7b09a7_idx",
                    ),
                ],
            },
        ),
