...
def _ticket_cache_key(raw_ticket: str) -> str:
    ...
    return f"realtime:ws_ticket:{digest}"
...
def issue_ws_ticket(
    *,
    ...
    cache.set(
        ...
        timeout=settings.HOUSTON_REALTIME_WS_TICKET_TTL_SECONDS,
    )
    return raw_ticket, settings.HOUSTON_REALTIME_WS_TICKET_TTL_SECONDS
