        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    ...
                    models.Index(fields=["signal", "status"], name="action_signal_status_idx"),
                    models.Index(
                        fields=["establishment", "assigned_to"], name="action_est_assignee_idx"
                    ),
                    models.Index(
                        fields=["establishment", "created_by"], name="action_est_creator_idx"
                    ),
                ],
            },
        ),
