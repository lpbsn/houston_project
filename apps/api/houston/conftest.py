...
_RELAXED_AUTH_THROTTLE_RATES = {
    ...
    settings.AUTH_THROTTLE_SCOPE_EMAIL_CHANGE: _RELAXED_AUTH_THROTTLE_RATE,
    settings.AUTH_THROTTLE_SCOPE_EMAIL_CHANGE_CONFIRM: _RELAXED_AUTH_THROTTLE_RATE,
    settings.AUTH_THROTTLE_SCOPE_PASSWORD_CHANGE: _RELAXED_AUTH_THROTTLE_RATE,
    settings.AUTH_THROTTLE_SCOPE_PASSWORD_RESET: _RELAXED_AUTH_THROTTLE_RATE,
    settings.AUTH_THROTTLE_SCOPE_PASSWORD_RESET_CONFIRM: _RELAXED_AUTH_THROTTLE_RATE,
