    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="assignees",
                        to="action_plans.actionplanexecutionteam",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                related_name="executions",
                to="action_plans.actionplanschedule",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="action_plans.actionplantask",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="actionplan",
            index=models.Index(
                fields=["establishment", "created_by"], name="ap_plan_est_creator_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="actionplan",
            constraint=models.CheckConstraint(
                condition=models.Q(("pilot_business_unit__isnull", False)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("catalog_status__isnull", True), ("is_reusable", True), _negated=True
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("catalog_status__isnull", False), ("is_reusable", False), _negated=True
                ),
        ...
        migrations.AddConstraint(
            model_name="actionplanexecutionteam",
            constraint=models.UniqueConstraint(
                condition=models.Q(("is_pilot", True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["establishment", "status"], name="action_plan_establi_aa853b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="actionplanschedule",
            index=models.Index(
                fields=["action_plan", "status"], name="action_plan_action__43081f_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="actionplanschedule",
        ...
        migrations.AddIndex(
            model_name="actionplanexecution",
            index=models.Index(
                fields=["source_signal", "status"], name="ap_exec_signal_status_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="actionplanexecution",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["action_plan", "position"], name="action_plan_action__15f041_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="actionplantask",
            constraint=models.UniqueConstraint(
                fields=("action_plan", "position"), name="uniq_action_plan_task_position"
            ),
        ),
        migrations.AddConstraint(
            model_name="actionplantask",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["action_plan_execution", "position"], name="action_plan_action__2ec13a_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="actionplanexecutiontask",
