...
class PipelineCandidateOutput(_StrictModel):
    ...
    operational_module_key: str = Field(min_length=1, max_length=100)
    operational_domain_key: str = Field(min_length=1, max_length=150)
    operational_subject_key: str = Field(min_length=1, max_length=200)
