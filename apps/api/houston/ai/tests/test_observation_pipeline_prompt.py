...
def test_prompt_version_constant_is_v3():
    assert AI_OBSERVATION_PIPELINE_PROMPT_VERSION == "ai_observation_pipeline_v3"


def test_system_prompt_is_french_and_covers_v3_rules():
...
@pytest.mark.django_db
def test_build_pipeline_input_includes_active_signals_context_v3():
    membership = build_membership()
    hotel = create_business_unit(
        establishment=membership.establishment,
        key="hotel",
