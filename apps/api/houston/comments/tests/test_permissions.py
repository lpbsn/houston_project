...
def test_can_resolve_execution_comment_author_assignee_creator_admin_manager():
    ...
    assert (
        can_resolve_execution_comment(membership=staff, execution=execution, comment=root)
        is True
    )
    assert (
        can_resolve_execution_comment(membership=owner, execution=execution, comment=root)
        is True
    )
    assert (
