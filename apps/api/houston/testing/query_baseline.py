...
# GET .../action-plan-execution-feed/?view_mode=general — owner, empty feed (Lot 5)
ACTION_PLAN_EXECUTION_FEED_EMPTY_MAX_QUERIES = 12
# GET .../action-plan-execution-feed/?view_mode=general — owner, 3 active executions (Lot 5)
ACTION_PLAN_EXECUTION_FEED_THREE_ITEMS_MAX_QUERIES = 14
