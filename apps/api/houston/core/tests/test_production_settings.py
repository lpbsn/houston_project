...
def test_production_deploy_check_allows_s3_backend_without_disk_root(valid_production_overrides):
    ...
    valid_production_overrides["HOUSTON_ACTION_PLAN_S3_ENDPOINT_URL"] = "https://s3.plans.invalid"
    valid_production_overrides["HOUSTON_ACTION_PLAN_S3_BUCKET"] = "action-plan-attachments"
    valid_production_overrides["HOUSTON_ACTION_PLAN_S3_ACCESS_KEY_ID"] = "plan-access-key"
    valid_production_overrides["HOUSTON_ACTION_PLAN_S3_SECRET_ACCESS_KEY"] = "plan-secret-key"
    valid_production_overrides["HOUSTON_ACTION_PLAN_S3_REGION"] = "auto"
    with override_settings(**valid_production_overrides):
        call_command("check", deploy=True)
