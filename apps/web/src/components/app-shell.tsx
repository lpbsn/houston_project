          ...
          <div className="flex items-start justify-between gap-3">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <span className="text-[2rem] font-black tracking-[-0.06em] text-[color:var(--primary)]">
                  houston
                </span>
                <Badge className="bg-[color:var(--primary)]/12 px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-[color:var(--primary)]">
                  {headingBadge}
                </Badge>
              </div>
