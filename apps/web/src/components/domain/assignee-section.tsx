...
type AssigneeSectionMultipleProps = AssigneeSectionBaseProps & {
  mode: 'multiple'
  assigneeIds: string[]
...
export type AssigneeSectionProps = AssigneeSectionSingleProps | AssigneeSectionMultipleProps

function getAvatarClass(index: number): string {
  return AVATAR_BG_CLASSES[index % AVATAR_BG_CLASSES.length] ?? AVATAR_BG_CLASSES[0]
}

function isMultipleMode(props: AssigneeSectionProps): props is AssigneeSectionMultipleProps {
