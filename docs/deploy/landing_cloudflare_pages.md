...
5. **Ne pas** activer le fallback SPA 404 vers `index.html` (sinon `/supprimer-compte/` sert l’accueil). Le fichier `_redirects` du build réécrit explicitement les pages légales vers leurs HTML.
