...
Authoritative tree: `OnboardingCatalogModule` → `OnboardingCatalogDomain` → `OnboardingCatalogSubject` (DB, seeded migration `0007`; historical seed in `legacy_onboarding_catalog_seed.py`).
